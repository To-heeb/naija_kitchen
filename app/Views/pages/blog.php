        ...
        <div class="container my-5">
            <div class="row">
                <div class="col-md-3">
                    ...
                    <a href="blog/create" class="shadow btn btn-light m-3 mr-auto">Create Blog</a>
                </div>
                <div class="col-md-9">
                            ...
                            <div class="food-item-wrap bg-white border-0 shadow">
                                <div class="figure-wrap bg-image" data-image-src="<?=base_url("uploads/{$product->image}")?>">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center"  >
                                        ...
                                        <div class="review" style="background-color:rgba(0,0,0,0.3)"><a href="#"><?=($product->fake_order) ? mt_rand(env("app.fake_order_min"),env("app.fake_order_max")):"0"?> views</a> </div>
                                    </div>
                                </div>
                                <div class="content">
