...
.category_card:hover{
    ...
    <section class="hero bg-image" data-image-src="<?=base_url("assets/images/foods/hero3.jpg")?>">
            ...
            <div class="container text-center hero-text font-white">
                            ...
                            <form action="<?=base_url("explore")?>">
                                ...
                                <div class="form-group">
                                    <div class="input-group bg-transparent">
                                        <input class="form-control form-control-lg " type="text" name="keyword" placeholder="I would like to eat..." >
                                        <div class="input-group-append">
                                            <button class="btn input-group-text bg-theme text-white border-0 d-flex align-items-center"><span>Search</span> <i class="fa fa-search ml-2"></i></button>
                                        </div>
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4 style="font-family:cursive"><span>1. </span>Search Choice</h4> </div>
                    <!-- end:Step -->
                    <div class="step-item step2">
                        ...
                        <h4 style="font-family:cursive"><span>2. </span>Order Food</h4> </div>
                    <!-- end:Step -->
                    <div class="step-item step3">
                        ...
                        <h4 style="font-family:cursive"><span>3. </span>Delivery or take out</h4> </div>
                    <!-- end:Step -->
                </div>
                <!-- end:Steps -->
            </div>
    ...
    <section class="">
        <div class="container-fluid">
            <div class="title text-center text-left-sm m-b-30">
                        <h2>Our Categories</h2>
                    </div>
            <div class="row categories-slides">
                <?php foreach($categories as $key):?>
                <div class="col-md-4 col">
                    <a href="<?=base_url("explore?keyword=&category={$key->id}&sortby=default&order=asc")?>" class="category_card card card-body my-2 d-flex align-items-center justify-content-center">
                        <h3 class="h3"><?=$key->title?></h3>
                    </a>
                </div>
                <?php endforeach?>
            </div>
            <div class="text-right">
                <a href="<?=base_url("explore")?>" class="text-right"> View All <i class="fa fa-arrow-alt-circle-right" aria-hidden="true"></i></a>
            </div>
        </div>
    </section>
    <section class="popular">
        <div class="container">
            <div class="title text-center text-left-sm m-b-30">
                <h2>Most Ordered Food This Week</h2>
            </div>
            <div class="row  slick-slider" id="add_to_cart_btn">
